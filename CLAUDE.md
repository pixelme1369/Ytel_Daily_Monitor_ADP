...
- The Agent Outcomes scatter chart's Y axis (`enr/over5`) is a **separate, deliberately approximate** metric (5-min threshold, not 2-min; documented in its own section below) — not touched by this fix.
